...
{
    //Here we have implemented all the "IStudentRepository" methods
    public class StudentRepository : IStudentRepository
    {
        ...
        {
            return await _dbContext.Students.Where(student => student.StudentName.Contains(name.ToLower())).FirstOrDefaultAsync(); //Instead of "Equel" use "Contains" for partially match the name
        }
